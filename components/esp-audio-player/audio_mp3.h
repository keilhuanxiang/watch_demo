...
typedef struct {
    ...
    // consecutive invalid frame decode errors within current track
    uint16_t continuous_error_count;

    // consecutive sync misses within current track
    uint16_t continuous_sync_miss_count;
} mp3_instance;
